      ...
      <nav className="max-w-7xl mx-auto bg-white/90 backdrop-blur-lg rounded-2xl shadow-lg border border-gray-200/50">
        <div className="flex items-center justify-between h-16 md:h-18 px-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden md:block">
            <button className="relative bg-black hover:bg-white hover:text-black text-white px-8 py-3 rounded-md font-medium transition-all duration-300 shadow-lg hover:shadow-2xl hover:scale-105 transform group overflow-hidden border-2 border-black">
